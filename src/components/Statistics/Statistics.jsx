    ...
    const Statistics = ({good,neutral,bad, countTotalFeedback, positivePercentage}) => {
        return(
            ...
            <StatisticsItem ><span>Total:</span> <span>{countTotalFeedback}</span> </StatisticsItem>
            <StatisticsItem ><span>Positive Feedback:</span> <span>{positivePercentage}%</span> </StatisticsItem>
